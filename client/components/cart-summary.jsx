  ...
  render() {
    ...
    return (
      ...
      <div>
        ...
        <h5 className="m-5 d-flex justify-content-between ">Item Total{`$${convertNumber(itemTotal)}`}<button className="btn btn-primary" onClick={() => this.props.setView('checkout', {})}>Checkout</button></h5>
      </div>

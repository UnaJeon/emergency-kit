  ...
  render() {
    return (
      <header className="p-2 bg-danger text-white d-flex justify-content-between">
        ...
        <p className="mr-5 mt-3">{this.props.cartItemCount}<span className="ml-2 ">Items</span><i className="fa fa-shopping-cart ml-2" aria-hidden="true" style={{ cursor: 'pointer' }} onClick={() => this.props.setView('cart', {})}></i></p>
      </header>
    );
